...
- **Si eres propietario de un hogar, elimínalo primero.** vondo no permite eliminar a un usuario que sigue siendo propietario de un hogar de pago o en prueba — quedaría un presupuesto sin propietario, miembros bloqueados, nadie capaz de arreglar la facturación. El botón Eliminar permanece deshabilitado hasta que hayas [eliminado el hogar](../hogares/#eliminar-un-hogar).
