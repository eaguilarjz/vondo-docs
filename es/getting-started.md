...
> **Cada dólar que tienes tiene una categoría antes de gastarlo.**
...
Ese es todo el vocabulario. Listo.
...
### 3. Registra tu actividad

Ve a **Actividad** para registrar lo que ha pasado. Tienes cuatro tipos:
...
- **Crédito** — devoluciones de una compra previa (cancela un gasto; no cuenta como ingreso nuevo)
...
La página de [Actividad](../actividad/) cubre divisiones, pagos de deuda y filtros en detalle.
...
Abre [Informes](../reports/) y mira el mes. ¿A dónde se fue realmente tu dinero? ¿Algo te sorprendió? Lleva lo que funcionó al siguiente mes, cambia lo que no.
...
| Tema | Qué cubre |
|---|---|
| [Presupuesto](../budget/) | Asignar dinero, Por asignar, estrategias de llenado rápido, objetivos, mover dinero, panel de detalle |
| [Cuentas](../accounts/) | Los seis tipos de cuenta, préstamos con seguimiento de interés, cerrar/reabrir, reordenar |
| [Actividad](../actividad/) | Los cuatro tipos, divisiones, pagos de deuda, filtros, estado conciliada |
...
Bienvenido. Ahora ve y pon cada dólar en su lugar.
