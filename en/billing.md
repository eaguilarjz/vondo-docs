...
vondo's subscription belongs to the **household**, not to you personally. When you sign up, vondo creates a household for you and starts that household's trial. If you later share the household with a partner or family member, they ride on the same subscription — no separate charge.
...
A few days before the trial ends, vondo will email you a one-time reminder so you can pick a plan or, if it's not for you, walk away cleanly. We'd rather you cancel than feel trapped.
...
- vondo shows a "subscription is paused" screen on sign-in with a **Resume subscription** button.
...
- Your vondo account becomes read-only — you can still log in, view, and export your data
- You won't lose your data
- You can subscribe again any time and pick up where you left off

> **Pro tip:** Before canceling, [export your transactions](../import-export/#exporting-your-data) as a CSV. Even though vondo doesn't delete your data when you cancel, having a local copy is good housekeeping.

### Canceling during the trial

If you decide vondo isn't for you during the trial, no action is required. The trial ends automatically, and since you never entered payment info, nothing is ever charged.
...
- **Annual is the cheapest.** If you're confident you'll be using vondo a year from now (most people are after a few months), annual saves money.
