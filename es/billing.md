...
- La fecha
- El monto
- Si fue pagada (y en qué fecha)
- Un enlace para ver o descargar la factura como PDF
...
Algunos escenarios menos comunes:

| Situación | Qué pasa |
|---|---|
| La prueba termina y no te has suscrito | La cuenta se vuelve de solo lectura. Los datos se quedan. Suscríbete para reactivar. |
