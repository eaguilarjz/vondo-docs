...
Cuando el verde es más alto que el rojo, ahorraste dinero ese mes. Cuando el rojo es más alto, gastaste más de lo que ganaste. A lo largo de un año, el patrón cuenta una historia.

> **Qué buscar:**
> - ¿Dos meses seguidos donde el rojo es más alto que el verde? Revisa qué cambió y atiéndelo. (Un mes es ruido. Dos es tendencia.)
> - ¿Un mes donde los gastos saltaron? Probablemente algo conocido — impuestos, un viaje grande, fiestas. Úsalo como recordatorio para presupuestar la próxima vez.
> - La pregunta "¿mis ingresos son consistentes?" se responde visualmente aquí. Si eres freelance, esta gráfica es oro.

Las etiquetas del eje X muestran "Mes Año" — el año se omite para el año actual, solo para reducir saturación. Pasa el cursor sobre cualquier barra para el monto exacto.
